...
# Create Events
events = Event.create([
  { title: Faker::Lorem.sentence, date: Faker::Date.forward(days: 30), description: Faker::Lorem.paragraph, beach: Beach.all.sample, user_id: User.all.sample.id },
  { title: Faker::Lorem.sentence, date: Faker::Date.forward(days: 30), description: Faker::Lorem.paragraph, beach: Beach.all.sample, user_id: User.all.sample.id },
  { title: Faker::Lorem.sentence, date: Faker::Date.forward(days: 30), description: Faker::Lorem.paragraph, beach: Beach.all.sample, user_id: User.all.sample.id }
])
...
# Create reviews
reviews = Review.create([
  { title: Faker::Quote.jack_handey, content: Faker::Quote.jack_handey, rating: Faker::Number.between(from: 1, to: 5), beach: Beach.all.sample, user_id: User.all.sample.id },
  { title: Faker::Quote.jack_handey, content: Faker::Quote.jack_handey, rating: Faker::Number.between(from: 1, to: 5), beach: Beach.all.sample, user_id: User.all.sample.id },
  { title: Faker::Quote.jack_handey, content: Faker::Quote.jack_handey, rating: Faker::Number.between(from: 1, to: 5), beach: Beach.all.sample, user_id: User.all.sample.id }
])
...
puts "Seeding completed ... water them and they will become trees !"
